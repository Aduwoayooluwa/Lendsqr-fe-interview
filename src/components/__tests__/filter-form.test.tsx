...
describe('FilterForm Component', () => {
  ...
  it('should render correctly when isVisible is true', () => {
    render(<FilterForm onSubmit={mockSubmit} isVisible={true} />);
  ...
  it('should not render when isVisible is false', () => {
    render(<FilterForm onSubmit={mockSubmit} isVisible={false} />);
  ...
  it('should reset the form fields when reset button is clicked', async () => {
      const { rerender } = render(<FilterForm onSubmit={mockSubmit} isVisible={true} />);
    ...
    rerender(<FilterForm onSubmit={mockSubmit} isVisible={true} />)
